...
int main(void)
{
  ...
  while (1)
  {
     printf("saveetha engineering college V\n");
     printf("scoft\n");
     HAL_Delay(500);
  }
}
...
## Output screen shots of Serial port utility   :
 ...
 <img width="989" height="817" alt="Screenshot 2026-02-09 134827" src="https://github.com/user-attachments/assets/c222cee3-54d1-43d5-9034-aae4855044ad" />
